...
const HeroVariant3 = ({ onRegisterClick }: { onRegisterClick: () => void }) => {
  return (
    <div className="relative bg-gradient-to-br from-gta-red via-orange-900/80 to-red-950 text-white py-16 lg:py-24 overflow-hidden min-h-screen flex items-center dark:from-red-900 dark:via-orange-900/80 dark:to-red-950">
