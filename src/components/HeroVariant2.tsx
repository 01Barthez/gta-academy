...
const HeroVariant2 = ({ onRegisterClick }: { onRegisterClick: () => void }) => {
  return (
    <div className="relative bg-gradient-to-br from-purple-900 via-indigo-900 to-slate-800 text-white py-16 lg:py-24 overflow-hidden min-h-screen flex items-center">
